                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-start">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12">
                                        ...
                                        <input {{ (session('username') != 'sadmin') ? 'readonly' : '' }} type="datetme-local" class="form-control editInputBox" id="date" name="date">
                                    </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success == 1) {
                    ...
                    setTimeout(() => {
                        window.location.href = PANELURL + "trainers/profile?id=" + param;
                    }, 1000);
                }
            },
            error: function(e) {
