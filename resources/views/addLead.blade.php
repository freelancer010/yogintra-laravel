        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    ...
                    <h1>Add <?php if (basename($_SERVER["REQUEST_URI"]) == 'addCustomer') {
                                echo 'Customer';
                            } else {
                                echo 'Leads';
                            }; ?></h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add <?php if (basename($_SERVER["REQUEST_URI"]) == 'addCustomer') {
                                                                    echo 'Customer';
                                                                } else {
                                                                    echo 'Leads';
                                                                }; ?></li>
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12">
                                        ...
                                        <input required type="text" class="form-control" id="date" name="date" readonly value="<?php date_default_timezone_set('Asia/Kolkata');
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12">
                                        ...
                                        <input required type="text" class="form-control" id="attendeeName"
                                            name="attendeeName" placeholder="Enter attendee name" readonly value="{{ session('username') }}">
                                    </div>
                                </div>
                            </div>
                    </div>
